...
echo '<a href="https://www.vikings.com/news/injury-report-commanders-week-9";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:62%;"><b>Vikings vs. Commmanders Final Week 9 Injury Report</b></p>';
echo '<a href="https://www.vikings.com/news/how-to-watch-stream-listen-commanders-week-9";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:57%;"><b>Watch, Stream & Listen to Vikings vs. Commanders</b></p>';
echo '<a href="https://www.vikings.com/news/special-teams-preps-new-challenges-offense-pressure-defense-void";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:52%;"><b>Experts: Vikings Favored by Most Against Commanders</b></p>';
echo '<a href="https://www.vikings.com/news/cbs-sports-previews-vikings-commanders-offenses-week-8";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:47%;"><b>CBS Sports Previews Vikings & Commanders Offenses</b></p>';
echo '<a href="https://www.vikings.com/news/zadarius-smith-nfc-defensive-player-month-october-2022";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:42%;"><b>ZaDarius Smith Wins NFC Player of Month for October</b></p>';
echo '<a href="https://www.vikings.com/news/commanders-storylines-cousins-returning-washington-first-time";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:37%;"><b>Cousins Returning to Washington for 1st Time</b></p>';
echo '<a href="https://www.vikings.com/news/adam-zimmer-nfl-coach-mourn-loss";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:32%;"><b>Vkings Mourn Loss of Adam Zimmmer</b></p>';
echo '<a href="https://www.vikings.com/news/tj-hockenson-tight-end-trade-lions";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:27%;"><b>Vkings Acquire TD T.J. Hockenson; Place Smith on IR</b></p>';
echo '<a href="https://www.vikings.com/news/lewis-cine-injury-update";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:22%;"><b>Minnesota Vikings Update on Lewis Cine</b></p>';
echo '<a href="https://www.vikings.com/news/blake-proehl-activated-myles-dorn-waived-roster-moves-2022";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:17%;"><b>Vikings Activate WR Blake Proehl; Waive S Myles Dorn</b></p>';
echo '<a href="https://www.vikings.com/news/theo-jackson-ty-chandler-ir-roster-moves-2022";><p style="font-family:Bahnschrift; color: yellow; font-size: 14px; position: fixed; left:4%; bottom:12%;"><b>Vikings Sign S Theo Jackson; Place Ty Chandler on IR</b></p>';
echo '<h4 style="font-family:Bahnschrift; color:purple; position: fixed; left:13%; bottom:3%;"><a href="https://www.vikings.com/news/";>More News</a></h4>';
echo '</fieldset>';
//Center Body images
