...
<p align="left"; style="display:inline-block; font-family:Arial Black; color:purple; position: fixed; left:16%;"><a href ="SkolSignIn.php">Sign In</a></p>
...
<p align="right"; style="display:inline-block; font-family:Arial Black; color:purple; position: fixed; right: 27%;"><a href ="SkolSeasonTickets.php">Buy</a></p>
...
<center><form action="SkolRegister.inc.php" method="POST"><fieldset>
...
<input type="text" id="zip" name="zip" maxlength="10" size="10" ><br><br>
